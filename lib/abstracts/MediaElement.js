...
/**
 * Sets the keyframe generation interval in seconds. The generation is a 
 * gstreamer force_key_unit event, thus not guaranteed to be effective
 *
 * @alias module:core/abstracts.MediaElement.setKeyframeInterval
 *
 * @param {external:Integer} interval
 *  Seconds between each keyframe. If left to zero, won't force.
 *
 * @param {module:core/abstracts.MediaElement~setKeyframeIntervalCallback} [callback]
 *
 * @return {external:Promise}
 */
MediaElement.prototype.setKeyframeInterval = function(interval, callback){
  var transaction = (arguments[0] instanceof Transaction)
                  ? Array.prototype.shift.apply(arguments)
                  : undefined;
  ...
  return disguise(this._invoke(transaction, 'setKeyframeInterval', params, callback), this)
};
/**
 * @callback module:core/abstracts.MediaElement~setKeyframeIntervalCallback
 * @param {external:Error} error
 */
